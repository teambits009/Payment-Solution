...
const TermsAndConditions = () => (
  <div className="min-h-screen bg-gradient-to-br from-Safarigamers-blue via-blue-700 to-Safarigamers-light-blue font-sans flex items-center justify-center py-12 px-6">
    <div className="max-w-3xl w-full bg-white bg-opacity-10 backdrop-blur-lg p-8 rounded-xl shadow-2xl text-white">
      ...
      <Link to="/" className="text-Safarigamers-light-blue underline hover:text-white transition">
        Back to Home
      </Link>
    </div>
  </div>
