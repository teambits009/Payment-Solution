    ...
    <nav className="bg-Safarigamers-blue text-white py-4 px-6 sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <a href="#customers" className="text-lg hover:text-Safarigamers-light-blue transition">
            For Customers
          </a>
          <a href="#merchants" className="text-lg hover:text-Safarigamers-light-blue transition">
            For Merchants
          </a>
          <Link
            to="/customer-signup"
      ...
      <div className="max-w-7xl mx-auto py-12 px-6">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Learn how Safarigamers Safarigamers uses your Credit Score—built from your purchase history and spending—to unlock flexible shopping and drive merchant success.
          </p>
        </header>
          ...
          <button
            ...
            className={`px-6 py-3 text-lg font-medium rounded-tl-md rounded-bl-md transition-all duration-200 ${
              activeTab === "customers"
                ...
                : "bg-gray-200 text-gray-700 hover:bg-Safarigamers-light-blue hover:text-white"
            }`}
          >
            For Customers
          </button>
        ...
        {activeTab === "customers" ? (
          <section id="customers" className="space-y-12">
            ...
            <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
              With Safarigamers Safarigamers, your Credit Score—calculated from your purchases and spending—determines your ability to shop now and pay later. Here’s the detailed process:
            </p>
            ...
            <div className="bg-white p-8 rounded-md shadow-md border border-gray-200 flex flex-col md:flex-row items-center gap-6">
              <div className="flex-shrink-0 w-16 h-16 bg-Safarigamers-blue text-white rounded-full flex items-center justify-center text-2xl font-bold">1</div>
              <div>
                ...
                <Link to="/customer-signup" className="mt-4 inline-block text-Safarigamers-blue hover:underline font-medium">
                  Start Now
                </Link>
              </div>
            </div>
          ...
          <section id="merchants" className="space-y-12">
            ...
            <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
              Partner with Safarigamers Safarigamers to leverage our Credit Score system—based on customer purchases and spending—to drive sales while we manage payments.
            </p>
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              to="/merchant-signup"
              className="border border-Safarigamers-blue text-Safarigamers-blue px-8 py-4 rounded-md font-medium text-lg hover:bg-Safarigamers-blue hover:text-white transition-all duration-200"
            >
              Join as a Merchant
            </Link>
          </div>
